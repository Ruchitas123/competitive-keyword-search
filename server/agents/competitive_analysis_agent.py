...
class CompetitiveAnalysisAgent:
    ...
    async def analyze_competitor_keywords(
        ...
        print(f"[CompetitiveAnalysisAgent] SUCCESS Capability identified: {capability.get('name')}")
        ...
        print(f"\n[CompetitiveAnalysisAgent] SUCCESS Found capability content from {len(competitor_content)} competitors")
        ...
        print(f"\n[CompetitiveAnalysisAgent] SUCCESS Generated {len(keyword_data['competitor_keywords'])} competitor keywords")
        print(f"[CompetitiveAnalysisAgent] SUCCESS Generated {len(keyword_data['suggested_keywords'])} suggested keywords")
